  ...
  return (
    ...
    <div className="App">
      <div className="movie-list">
        {Movies.map(movie =>
          <Movie name={movie.name} poster={movie.poster} rating={movie.rating} summary={movie.summary} />
        )}
      </div>
    </div>
...
//App here is componant
//Capital letter
//return jsx

//{} Tempalate syntax =/interpolation or substitution